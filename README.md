...
当前仓库已进入 **Demo V2 Experience Proof**。预设教室继续使用人工构造 Mock Fixture，并已升级为 Desktop-first Classroom Scene、Student Character System，以及一条显式 Mock 的 Candidate Seat → 同桌演示路径；真实知乎 Snapshot、Candidate API 与 Live Pipeline 尚未接入。
...
- 【Implemented】`/classroom/q_learn_programming`：主教室 + 上下文栏、40 个原创 Canvas Student Character、5 个观点簇、Student Detail Sheet、证据回溯与等价文字视图。
