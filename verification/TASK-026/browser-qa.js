...
async (page) => {
  ...
  const shot = async name => {
    ...
    await page.screenshot({ path: `output/playwright/TASK-026/${name}-${suffix}.png`, fullPage: viewport.width < 500 });
  ...
  for (const [index, questionId] of rooms.entries()) {
    ...
    await download.saveAs(`output/playwright/TASK-026/${number}-classnote-${suffix}.md`);
